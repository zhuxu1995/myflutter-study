...
part of 'pub_item_pack.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

pubItemPack _$pubItemPackFromJson(Map<String, dynamic> json) {
  return pubItemPack(
    json['total_count'] as int,
    (json['items_pack'] as List)
        ?.map((e) =>
            e == null ? null : Items_pack.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}

Map<String, dynamic> _$pubItemPackToJson(pubItemPack instance) =>
    <String, dynamic>{
      'total_count': instance.total_count,
      'items_pack': instance.items_pack,
    };

Items_pack _$Items_packFromJson(Map<String, dynamic> json) {
  return Items_pack(
    json['items'] == null
        ? null
        : Items.fromJson(json['items'] as Map<String, dynamic>),
    json['bargain_rules'] as List,
    json['pin_tuans'] as List,
  );
}

Map<String, dynamic> _$Items_packToJson(Items_pack instance) =>
    <String, dynamic>{
      'items': instance.items,
      'bargain_rules': instance.bargain_rules,
      'pin_tuans': instance.pin_tuans,
    };
